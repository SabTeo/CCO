function DisplayCollezione(e){
    ...
    if(e=='default'){
        $("#zonaCarte").load("Carte.php",{sort:'order by id',check: sessionStorage.getItem("check")},
            ...
            $("#zonaCarte").load("Carte.php",{sort:'order by nomecarta',check: sessionStorage.getItem("check")},
            function(responseTxt, statusTxt, xhr){
            if(statusTxt == "error")
            alert("Errore" + xhr.status + ":" + xhr.statusText);
            });
